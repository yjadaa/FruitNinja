...
public class BladeLeft : MonoBehaviour {
	
	public AudioClip SwordHitEachOthersSound;
	...
	void OnTriggerEnter(Collider other) {
        if(other.name == "RightSwordCollider")
		{
			audio.PlayOneShot(SwordHitEachOthersSound, 0.1f);
		}
